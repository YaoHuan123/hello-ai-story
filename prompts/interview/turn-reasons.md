...
3. `question` and `reason`: language follows `outputLocale`. **Do not** use screening phrasing (`Is there…`, `Are there…`, `Did you ever…`, or Chinese equivalents like「有没有…」「你是否曾经…」).
