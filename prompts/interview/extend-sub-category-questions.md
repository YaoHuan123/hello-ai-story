...
2. Each `q` ≤ 180 characters, open-ended English; prefer concise wording. Avoid bare yes/no as the **only** question — but a conversational question may imply a **closed choice** (see §6).
